...
def build_nlp(domain=None, cfg_file=None, model="en_core_web_sm"):
    ...
    sectionizer = Sectionizer(nlp, rules=None, phrase_matcher_attr="LOWER")
    nlp.add_pipe(sectionizer, first=True)
    ...
    # Don't know how to load the postprocess rules from a config file
